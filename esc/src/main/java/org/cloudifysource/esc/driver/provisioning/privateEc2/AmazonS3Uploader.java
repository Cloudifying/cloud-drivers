...
public class AmazonS3Uploader {
	...
	public AmazonS3Uploader(final Cloud cloud, final String locationId) {
		...
		if (endpoint != null) {
			logger.info("setting S3 endpoint to: " + endpoint);
			s3client.setEndpoint(endpoint);
		} else if (locationId != null) {
			Region s3Region = RegionUtils.convertLocationId2Region(locationId);
